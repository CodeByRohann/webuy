            ...
            <div className="max-w-[76rem] mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-24">
                    ...
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-4xl md:text-[56px] font-bold tracking-tight text-[#09090b] mb-6 leading-[1.05]"
                    >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 relative z-10">
                        {steps.map((step, idx) => (
                            <motion.div
                                ...
                                className="relative bg-white rounded-[36px] p-8 lg:p-12 border border-gray-200 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(37,99,235,0.1)] hover:-translate-y-2 hover:border-blue-200 transition-all duration-500 group"
                            >
                                ...
                                <h3 className="text-[26px] font-bold text-[#09090b] mb-4 text-center md:text-left tracking-tight">
                                    {step.title}
                                </h3>
                                ...
                                <div className="absolute top-4 right-6 text-[140px] font-black leading-none text-gray-100 select-none group-hover:text-blue-50 transition-colors duration-500 pointer-events-none z-0 tracking-tighter">
                                    {idx + 1}
                                </div>
                            </motion.div>
                        ))}
